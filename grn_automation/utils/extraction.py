...
class AWSTextractSAPExtractor:
    ...
    def extract_sap_data(self, pdf_path: str) -> Dict[str, Any]:
        """
        Main method to extract SAP data from PDF file
        
        Args:
            pdf_path (str): Path to the PDF file
            
        Returns:
            Dict containing extracted data structure:
            {
                'success': bool,
                'sap_fields': dict,
                'expense_data': dict,
        ...
        try:
            ...
            if not images:
                return {
                    'success': False,
                    'error': 'PDF conversion failed - unable to convert PDF to images',
                    'file_path': pdf_path
                }
            ...
            if results['expense_data'].get('confidence_scores'):
                confidence_scores = results['expense_data']['confidence_scores']
